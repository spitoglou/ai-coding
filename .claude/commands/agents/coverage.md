...
3. Invoke the test-engineer agent:
   ...
   **Coverage Commands by Project Type:**
   - Python: uv run pytest --cov=. --cov-report=term-missing
   - Node.js: npm test -- --coverage
   - Rust: cargo tarpaulin
   - Go: go test -cover ./...
   
   **Focus Areas:**
   - Critical paths (auth, core workflows, data integrity)
   ...
   **Output:**
   - Report: .claude/reports/tests/tests-coverage-[scope]-YYYY-MM-DD.md
   ")
   ```
...
**Example Usage**
```
/agents:coverage                    # Full codebase coverage
/agents:coverage lib/services/      # Specific directory
